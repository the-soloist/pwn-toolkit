...
def b62encode(text):
    """ bytes -> str """
    return base62.encodebytes(t2bytes(text))
...
def b64encode(text, base_table=None):
    """ bytes -> bytes """
...
def b64decode(text, base_table=None):
    """ bytes -> bytes """
...
def b64encode_urlsafe(text):
    """ bytes -> bytes """
    return base64.urlsafe_b64encode(t2bytes(text))


def b64decode_urlsafe(text):
    """ bytes -> bytes """
...
def b91encode(text):
    """ bytes -> str """
    return base91.encode(t2bytes(text))
...
def b92encode(text):
    """ [bytes, str] -> str """
    return base92.encode(t2bytes(text))


def b92decode(text):
    """ str -> str """
    return base92.decode(t2str(text))
